                        ...
                        <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full  pb-8 space-y-4 md:space-y-0">
                            ...
                            <div className="flex justify-between space-x-8 items-start w-full">
                                <p className="text-base xl:text-lg leading-6">
                                    {data.cart[0].discountPrice} <span className="text-red-300 line-through"> {data.cart[0].orginalPrice}</span>
                                </p>
                                <p className="text-base xl:text-lg leading-6 text-gray-800">{data.cart[0].qty}</p>
                                <p className="text-base xl:text-lg font-semibold leading-6 text-gray-800">{data.totalPrice}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                    <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                        ...
                        <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                            ...
                            <div className="flex justify-between items-center w-full">
                                <p className="text-base leading-4 text-gray-800">{data?.paymentInfo.user === "Cash on Delivery"}</p>
                                <p className="text-base leading-4 text-gray-600">{data.paymentInfo?.status}</p>
                            </div>
                        </div>
                        <div className="flex justify-between items-center w-full">
