                        ...
                        <span className="inline-block h-8 w-8 rounded-full overflow-hidden">
                            {
                                ...
                                (
                                    ...
                                    <TbUserCircle className="h-8 w-8 text-blue-600 hover:text-blue-500" />
                                )
                            }
                        </span>
                        <label htmlFor="file-input"
                        className="ml-5 flex  items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                <span>Upload your picture</span>
                                <input type="file" name="avatar" id="file-input" accept=".jpg,.jpeg,.png" 
                                onHandle={handleFileInputChange}
                                className="sr-only"
                                />
                        </label>
                    </div>
