...
const AllUsers = () => {
    ...
    //         try {
    //             const response = await axios.get(`http://localhost:8000/api/v2/user/admin-all-users`, {
    ...
    await axios.delete(`${server}/user/admin-delete-user/${id}`, {withCredentials:true}).then((res)=>{
    ...
    return (
        <div className='w-full flex justify-center items-center'>
            <div className="w-[95%]">
                <h3 className="text-[22px] font-Poppins pb-2 pt-5"><strong>All Users</strong></h3>
